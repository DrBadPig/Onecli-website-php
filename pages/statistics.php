	...
	<div style="display: none;" class="modals">
		<!--SEND BALANCE MODAL-->
		<div style="display: none;" class="modal-send df-col">
			<!--SEND BALANCE TO A FRIEND SECTION-->
			<div style="display: none;" class="modal-send-wrapper div-flex df-col df-spacea">
				...
				<span class="t-uppercase t-gray t-bold-300"><span class="t-main">Отправить Баланс другу</span> | <span>Реинвест</span></span>
			...
			<!--REINVEST SECTION-->
			<div class="modal-send-wrapper modal-send-reinvest div-flex df-col df-spacea">
				<div class="modal-close-button">
					<svg xmlns="http://www.w3.org/2000/svg" width="14.798" height="14.798" viewBox="0 0 14.798 14.798">
  						<g transform="translate(0.707 0.707)">
    						<line x2="13.384" y2="13.384" fill="none" stroke="#fff" stroke-width="2"/>
				...
				<span class="t-uppercase t-gray t-bold-300"><span>Отправить Баланс другу</span> | <span class="t-main">Реинвест</span></span>
				<div class="modal-your-balance div-flex-two t-white t-bold-300">
					<span class="t-size-20">Ваш баланс:</span>
					<div>
						<span class="t-size-25">24 548$</span>
	...
	<main class="main-content">
		...
		<div class="shares-info div-flex df-spaceb container">
			<div class="si-block light-green">
				<span>Баланс</span>
				<span class="value">0.0048</span>
			</div>
			<div class="si-block green">
				<span>Всего USD</span>
				<span class="value">296.110 $</span>
			</div>
			<div class="si-block green">
				<span>Команда</span>
